...
function sendEmailVerification() {
    ...
    if (name === "" || email === "" || password === ""||chooseProfile=== "") {
        // Display error message in red
        document.getElementById("smessage").innerHTML = "<span style='color: red;'>Please fill all fields.</span>";
        return;
    }
    ...
    if (!isOTPVerified) {
        ...
        document.getElementById("smessage").innerHTML = "<span style='color: red;'>Please verify your email by OTP.</span>";
        return;
    }
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.success) {
                ...
                if (response.message.includes("Email already registered")) {
                    document.getElementById("smessage").innerHTML = "<span style='color: red;'>" + response.message + "</span>";
                } else {
                    document.getElementById("smessage").innerHTML = "<span style='color: red;'>Failed to complete registration. Please try again.</span>";
                }
            }
        },
        ...
        if (xhr.status === 400) {
            document.getElementById("smessage").innerHTML = "<span style='color: red;'>" + xhr.responseJSON.message + "</span>";
        } else {
            document.getElementById("smessage").innerHTML = "<span style='color: red;'>Failed to complete registration. Please try again.</span>";
        }
    }
